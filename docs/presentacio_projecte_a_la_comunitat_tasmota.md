...
- **[BlauClick](https://github.com/CasamaMaker/BlauClick)** — battery-powered ESP32-C3 button (~1 year battery life, no wiring needed)
- **[BlauLux](https://github.com/CasamaMaker/BlauLux)** — ESP32-C3 load controller (relay, PWM, AC phase dimmer, NeoPixel/WS2812)
...
BlauClick board
![BlauClick board](https://raw.githubusercontent.com/CasamaMaker/BlauClick/main/pictures/2.jpg)

BlauClick captive portal

<img src="https://raw.githubusercontent.com/CasamaMaker/BlauClick/main/pictures/web-manager.png" width="400">

BlauLux captive portal

<img src="https://raw.githubusercontent.com/CasamaMaker/BlauLux/main/docs/web-manager.png" width="400">